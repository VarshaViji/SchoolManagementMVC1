...
Param(
    ...
    [string] $ResourceGroupName = 'SchoolManagementMVC',
    [switch] $UploadArtifacts,
    [string] $StorageAccountName,
    [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
    [string] $TemplateFile = 'sms.workflow.sendemailalert.json',
    [string] $TemplateParametersFile = 'sms.workflow.sendemailalert.parameters.json',
